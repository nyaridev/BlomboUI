import type { CivitaiLayoutData } from '@/views/fileinfo/panels/civitai/CivitaiLayouts.tsx'
import { Base, Desc, Meta, Name, Pills } from '@/views/fileinfo/panels/civitai/CivitaiLayouts.tsx'
import type { TagCount, TrainingField, TrainingGroup } from '@/views/fileinfo/panels/safetensors/safetensors.ts'
