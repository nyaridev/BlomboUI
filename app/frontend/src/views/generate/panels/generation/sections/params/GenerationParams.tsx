...
import { ASPECTS, SAMPLERS, SCHEDULERS, formatSize, inferScaler, listedChoices, orientSize, parseSize, sizeFromScaler, snapToSet, type ResMode } from '@/views/generate/panels/generation/sections/params/resolutions.ts'
...
export function GenerationParams({
  ...
  return (
    <aside className="flex min-w-0 flex-col gap-stack">
      ...
      <div className="grid grid-cols-[minmax(0,70%)_auto_minmax(0,1fr)] items-center gap-stack">
        ...
        <IconButton aria-label="Swap width and height" onClick={swapSize}><AppIcon id="arrow-up-down" /></IconButton>
        <div className="flex min-w-0 flex-col gap-2">
