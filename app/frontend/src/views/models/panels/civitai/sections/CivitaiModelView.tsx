...
import { creatorUrl } from '@/views/fileinfo/panels/civitai/CivitaiLayouts.tsx'
import { CivitaiPreviewStrip } from '@/views/models/panels/civitai/sections/CivitaiPreviewStrip.tsx'
  ...
  if (busy) {
    return (
      <div className="flex min-h-0 flex-1 items-center justify-center">
        <CivitaiLoadingCircle label="Loading model…" />
      </div>
    )
  }
  if (error) {
