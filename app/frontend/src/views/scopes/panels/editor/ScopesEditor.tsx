...
import { ScopeEditor } from '@/views/scopes/panels/editor/sections/ScopeEditor.tsx'
import { groupedScopes, groupValue, nameKey, placeScope, UNGROUPED } from '@/views/scopes/panels/editor/sections/scopeTree.ts'
