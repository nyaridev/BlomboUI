...
export function CivitaiAccountSection({ query = '' }: { query?: string }) {
  ...
  return (
    <div className="flex max-w-xl flex-col gap-3">
      <SettingsCard
        ...
        id="settings-civitai"
      >
        <SettingsField setting="civitaiSite">
          <SelectField
            value={civitaiSite}
        ...
        <SettingsField setting="civitaiApiKey" className="flex items-start gap-2">
      ...
      <SettingsCard query={query} title="Automatic retry" terms="civitai request search error retry attempts">
        <SettingsField setting="civitaiAutoRetry">
          <label className="flex items-center gap-2 text-sm text-ink">
            <CheckboxControl checked={autoRetry} onChange={setAutoRetry} />
            Automatically retry failed CivitAI searches
          </label>
        </SettingsField>
        <SettingsField setting="civitaiAutoRetryCount" className="flex items-start gap-2">
          <label className="flex min-w-0 flex-1 flex-col gap-1 text-sm text-ink">
...
export function CivitaiMetadataSection({ query = '' }: { query?: string }) {
