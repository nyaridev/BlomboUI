...
export function HistorySection({ query = '' }: { query?: string }) {
  ...
  return (
    <div className="flex max-w-xl flex-col gap-3">
      <SettingsCard query={query} title="Keep" terms="keep limit store download browse pages viewed history">
        <SettingsBlock query={query} title="Download history" terms="download keep limit store" setting="downloadHistoryLimit">
        ...
        <SettingsBlock query={query} title="Browse history" terms="browse pages viewed keep limit store" setting="browseHistoryLimit">
      ...
      >
        <SettingsBlock query={query} title="Thumbnail megapixels" terms="megapixels size cap resize" setting="downloadThumbMegapixels">
          <SliderField
        ...
        <SettingsBlock query={query} title="Image format" terms="png jpg jpeg webp still photo" setting="downloadThumbImageFormat">
          <SelectField
        ...
        <SettingsBlock query={query} title="Video format" terms="gif webp video animated" setting="downloadThumbVideoFormat">
          <SelectField
        ...
        <SettingsBlock query={query} title="Thumbnail quality" terms="jpeg webp jpg quality" setting="downloadThumbQuality">
