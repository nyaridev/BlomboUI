import { LineList } from '@/views/wildcards/panels/content/sections/LineList.tsx'
import { RawEditor } from '@/views/wildcards/panels/content/sections/RawEditor.tsx'
import { WildcardFileBar } from '@/views/wildcards/panels/content/sections/WildcardFileBar.tsx'
import { YamlEditor } from '@/views/wildcards/panels/content/sections/YamlEditor.tsx'
import type { WildcardFile, YamlNode } from '@/lib/api.ts'

export function WildcardsEditor({
  draft,
  dirty,
  raw,
  busy,
