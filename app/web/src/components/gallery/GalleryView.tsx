import { GalleryOverlays } from '@/components/gallery/GalleryOverlays.tsx'
import {
  buildGalleryTree,
  collectDirPaths,
  displayToIdent,
...
import { GalleryTiles } from '@/components/gallery/GalleryTiles.tsx'
import { GalleryToolbar, GALLERY_SORTS, type GallerySortDir, type GallerySortKey } from '@/components/gallery/GalleryToolbar.tsx'
import {
  chrome,
  EMPTY_TYPES,
  fileName,
  ...
  TREE_REM,
  LOCAL_ID,
} from '@/components/gallery/galleryUtils.ts'
...
import { useGalleryFileOps } from '@/components/gallery/useGalleryFileOps.ts'
import { useGalleryAutoTypes } from '@/components/gallery/useGalleryAutoTypes.ts'
  ...
  return (
    <div className={fill ? 'flex h-full min-h-0 flex-col gap-2' : 'flex flex-col gap-2'}>
      <GalleryToolbar
        ...
        shareLabel={generate ? 'Generate galleries' : 'Models galleries'}
        autoType={autoType}
